...
public class SearchByPriceM {
	
	
	
	public SearchByPriceM(String c_id, String c_name){
		
		
	JFrame j=new JFrame("Search By Mobile Price(TAKA)");
	...
	search.addActionListener(e->{
		...
		int numVal1 = Integer.parseInt(fromv);
		
		String tov = to.getText();
		int numVal2 = Integer.parseInt(tov);
		
		Mobile_ctgr.searchByMobileUnitPrice(numVal1,numVal2);
	});
